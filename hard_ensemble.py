...
csv_paths = [
    '/data/ephemeral/home/results/ensemble_results_thr7.csv',
    '/data/ephemeral/home/results/ensemble_results_hrnet_thr5.csv',
    '/data/ephemeral/home/repo/results/segformer_output.csv',
             ]
